...
//   ZONE7A     : origin = 0x200000, length = 0x00FC00    /* XINTF zone 7 - program space */
   ...
   ZONE7A	  : origin = 0x270B80, length = 0x00F47F
PAGE 1 :
   /* BOOT_RSVD is used by the boot ROM for stack.               */
   /* This section is only reserved to keep the BOOT ROM from    */
   /* corrupting this area during the debug process              */
   BOOT_RSVD  : origin = 0x000002, length = 0x00004E     /* Part of M0, BOOT rom will use this for stack */
   RAMM1      : origin = 0x000450, length = 0x0003B0     /* on-chip RAM block M1 */
   RAML4      : origin = 0x2EFFFF, length = 0x010000
   RAML5      : origin = 0x00FCC0, length = 0x0002E0
   RAML6      : origin = 0x00FFA0, length = 0x000040
   RAML7      : origin = 0x00FFE0, length = 0x000020
   ZONE6B     : origin = 0x100000, length = 0x0FFFFF
   ZONE7B     : origin = 0x200000, length = 0x070B80     /* XINTF zone 7 - data space */
}
...
SECTIONS
{
   ...
   .text            : > ZONE7A,    PAGE = 0   //所有可以执行的代码和常量，系统自动分配给两个地址段
   ...
   .esysmem         : > RAMM1,     PAGE = 1   //为动态存储分配保留的空间，far_malloc函数产生的内存
   .sysmem          : > RAMM0,     PAGE = 0   //malloc函数产生的内存，不超过64K长度
